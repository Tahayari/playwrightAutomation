...
public class PlaywrightFactory {
    ...
    public static BrowserContext createMobileContext(String authStatePath, double timeout) {
        ...
        if (DEVICE_PROFILES.containsKey(deviceName)) {
            ...
            options = new Browser.NewContextOptions().setViewportSize(1920, 1080);
    ...
    static {
        // Define iPhone 14
        DEVICE_PROFILES.put("iPhone 14", new Browser.NewContextOptions()
        ...
        DEVICE_PROFILES.put("Pixel 7", new Browser.NewContextOptions()
                .setPermissions(Collections.singletonList("geolocation"))
                .setGeolocation(geolocation.latitude, geolocation.longitude)
        ...
        DEVICE_PROFILES.put("Urovo", new Browser.NewContextOptions()
                .setPermissions(Collections.singletonList("geolocation"))
                .setGeolocation(geolocation.latitude, geolocation.longitude)
                .setUserAgent("Mozilla/5.0 (Linux; Android 12; DT50_5G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Mobile Safari/537.36")
