...
public class EvidenceManager {
    ...
    /**
     * Takes a full-page screenshot as raw bytes and attaches them directly to the current Allure
     * test case. Thread-safe: Allure.addAttachment() resolves the target test by the calling
     * thread's UUID.
     */
